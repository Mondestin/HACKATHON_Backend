...
class RoomResponse(RoomBase):
    ...
    updated_at: datetime = Field(..., description="Room last update timestamp")
...
class StudentResponse(StudentBase):
    ...
    created_at: datetime = Field(..., description="Student creation timestamp")
    updated_at: datetime = Field(..., description="Student last update timestamp")
...
class ProfessorResponse(ProfessorBase):
    ...
    user_id: str = Field(..., description="Associated user ID")
    created_at: datetime = Field(..., description="Professor creation timestamp")
    updated_at: datetime = Field(..., description="Professor last update timestamp")
